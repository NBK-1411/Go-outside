  ...
  const slides = [
    {
      ...
      description: "Find authentic social experiences across Ghana",
      icon: "🎉",
    },
    {
      title: "AI plans your perfect weekend.",
      description: "Get personalized recommendations based on your mood and budget",
      icon: "🤖",
    },
    {
      title: "Pay safely and share your experience.",
      description: "Secure payments and connect with the community",
      icon: "✨",
    },
  ]
